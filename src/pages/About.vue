<template>
  <section class="container">
    <article class="content is-medium">
      ...
      <h5>Pourquoi devenir freelance ?</h5>
      ...
      <h5>Pourquoi vous choisir vous plutôt qu un autre ?</h5>
      <p>Tout d'abord l demande est forte et vous n'avez pas beaucoup de choix.
        Je dirai que mes points fort sont l’écoute et l'ouverture d'esprit pour
        ne pas rester blocker dans une approche mais en essayant de trouver
        la solution optimale pour répondre au mieux au besoin du client.</p>
      <h5>Et votre temps libre ?</h5>
